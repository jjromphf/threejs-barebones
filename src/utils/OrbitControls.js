...
export default function loadOrbitControls(_three) {
  _three.OrbitControls = function ( object, domElement ) {
  	...
  	// Mouse buttons
  	this.mouseButtons = { ORBIT: _three.MOUSE.LEFT, ZOOM: _three.MOUSE.MIDDLE, PAN: _three.MOUSE.RIGHT };
  ...
  Object.defineProperties( _three.OrbitControls.prototype, {

  	center: {

  		get: function () {

  			console.warn( '_three.OrbitControls: .center has been renamed to .target' );
  			return this.target;
  	...
  	noZoom: {
  		...
  		get: function () {
  			...
  			console.warn( '_three.OrbitControls: .noZoom has been deprecated. Use .enableZoom instead.' );
  	...
  	noRotate: {
  		...
  		get: function () {
  			...
  			console.warn( '_three.OrbitControls: .noRotate has been deprecated. Use .enableRotate instead.' );
  	...
  	noPan: {
  		...
  		get: function () {
  			...
  			console.warn( '_three.OrbitControls: .noPan has been deprecated. Use .enablePan instead.' );
  	...
  	noKeys: {
  		...
  		get: function () {
  			...
  			console.warn( '_three.OrbitControls: .noKeys has been deprecated. Use .enableKeys instead.' );
  	...
  	staticMoving: {
  		...
  		get: function () {
  			...
  			console.warn( '_three.OrbitControls: .staticMoving has been deprecated. Use .enableDamping instead.' );
  	...
  	dynamicDampingFactor: {
  		...
  		get: function () {
  			...
  			console.warn( '_three.OrbitControls: .dynamicDampingFactor has been renamed. Use .dampingFactor instead.' );
